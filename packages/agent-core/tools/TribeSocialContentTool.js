...
export class TribeSocialContentTool {
     ...
     */
    async listContentAsComponentSchema(collectionId, query, sessionToken) {
        if (!collectionId) {
    ...
    async getContentByIdAsComponentSchema(contentId, sessionToken) {
     ...
     */
    async getContentForContext(contextKey) {
